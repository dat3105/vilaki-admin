            ...
            <div>
                ...
                <Nav pullRight>
                    ...
                    <NavDropdown
                        ...
                        <MenuItem eventKey={4.5}><div className="text-danger" onClick={this.logout}><i className="pe-7s-close-circle"></i> Log out</div></MenuItem>
                    </NavDropdown>
                </Nav>
            </div>
        );
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        ...
        setAuth: ()=> {
            dispatch({type:"CHANGE_AUTHED_FALSE"})
        }
    }
}
